        ...
        <div className="grid place-items-center p-4">
          {loading ? (
            <>
              ...
              <p className="animate-pulse mt-6">loading..</p>
            </>
          ) : error ? (
            <p>Error: {error}</p>
          ) : (
            dogImage && (
              <div className=" grid place-items-center shadow-md rounded-md  p-4 bg-sky-700  ">
                ...
                <button
                  ...
                  className="ring-2 ring-offset text-slate-300 bg-sky-800  w-max font-bold rounded-md  p-2 mt-3 hover:bg-sky-900 active:bg-sky-800 transition-colors duration-100"
                >
                  Refresh
                </button>
              </div>
